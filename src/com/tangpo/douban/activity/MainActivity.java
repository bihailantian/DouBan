...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabsAdapter.addTab(mTabHost.newTabSpec("tab1").setIndicator(tab_item1),
				com.tangpo.douban.fragment.HomeFragment.class, null);
		mTabsAdapter.addTab(mTabHost.newTabSpec("tab2").setIndicator(tab_item2),
				com.tangpo.douban.fragment.FeedFragment.class, null);
		mTabsAdapter.addTab(mTabHost.newTabSpec("tab3").setIndicator(tab_item3),
				com.tangpo.douban.fragment.SubjectFragment.class, null);
		mTabsAdapter.addTab(mTabHost.newTabSpec("tab4").setIndicator(tab_item4),
				com.tangpo.douban.fragment.QuanziFragment.class, null);
		mTabsAdapter.addTab(mTabHost.newTabSpec("tab5").setIndicator(tab_item5),
				com.tangpo.douban.fragment.ProfileFragment.class, null);
